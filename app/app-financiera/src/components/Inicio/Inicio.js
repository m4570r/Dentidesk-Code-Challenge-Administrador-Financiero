...
function Inicio() {
  return (
    <div className="inicio texto-contenedor">
      <h2>Gestiona tus Finanzas con Facilidad</h2>
      <p className="texto-margen">Nuestra aplicación está dedicada a simplificar la vida financiera de personas y empresas, brindando una solución integral para llevar un control efectivo de la contabilidad y los gastos mensuales. Nos enorgullece ser tu aliado en el camino hacia la estabilidad financiera, ayudándote a gestionar tus finanzas de manera inteligente y eficiente.</p>
